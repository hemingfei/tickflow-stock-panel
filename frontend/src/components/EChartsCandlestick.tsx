...
export function EChartsCandlestick({
  ...
  // 主题和价格颜色: 切换时触发重建 (buildOption/信息栏内部动态取调色板)
  ...
  }, [data, markers, ranges, priceLines, linkedPrice, showMA, showMarkersProp, activeIndicators, volumeCompare, addedDate, chartHeight, dates, dateIndexMap, initialZoom, getInfoBarHTML, theme, priceColors])
